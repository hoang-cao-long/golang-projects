...
var (
	...
	domain = flag.String("domain", "hoang-cao-long-instance-suwuca.us1.zitadel.cloud", "hoang-cao-long-instance-suwuca.us1.zitadel.cloud")
	key    = flag.String("key", "./289681723866804899.json", "./289681723866804899.json")
	port   = flag.String("port", "8090", "8090")
